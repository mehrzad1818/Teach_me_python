# This is Day 14 of 100 Days of coding.
#
...
# 2. make a todo list and start with the easiest
# 3. turn the problems into comments into your code
# 4. write code -> run code -> fix code -> again
...
def game():
    ...
    while break_game == False:
        ...
        Players_input = input(
            str("Who has more followers? Type 'A' or 'B': ")).lower
...
# This part is the feasble solution to this project.
